                ...
                >
                    ...
                    <Modal.Description>
                        <List bulleted relaxed>
                            ...
                            <List.Item><strong>Logic:</strong> this application scans all your host entities across all the accounts that you have access to. First, it selects EC2 instances
                                 and then it collects all the services running in these EC2. It displays the data for each host and compare the tags between the host and the services.</List.Item>
                            <List.Item><strong>Rules and Features:</strong>
                                <List.List>
                                    <List.Item>The sync logic is similar to Linux rsync command. The application will first compare the services tags and host tags 
                                    ...
                                    <List.Item>If the service has a tag that does not exist in the host tags list, it will NOT be removed. This is important to provide the flexibility
                                        to add some additional tags manually to NR services.</List.Item>
                                    ...
                                    <List.Item>If the EC2 instance is hosting multiple services, all of them will be returned.</List.Item>
                                    <List.Item>You can select the NR services to update by checking the corresponding checkbox.</List.Item>
